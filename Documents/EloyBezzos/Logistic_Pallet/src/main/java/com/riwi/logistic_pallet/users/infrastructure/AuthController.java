package com.riwi.logistic_pallet.users.infrastructure;

import org.springframework.web.bind.annotation.RestController;

import com.riwi.logistic_pallet.common.infrastructure.dtos.response.ProblemDetailWithErrors;
import com.riwi.logistic_pallet.users.application.AuthService;
...
import com.riwi.logistic_pallet.users.infrastructure.dtos.response.LoginResponseDataDto;
import com.riwi.logistic_pallet.users.infrastructure.dtos.response.LoginResponseDto;
import com.riwi.logistic_pallet.users.infrastructure.dtos.response.RegisterResponseDto;
...
public class AuthController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "User authentication is successful", content = {
